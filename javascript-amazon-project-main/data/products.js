...
export class Product {
  ...
  getPrice () {
    return `$${formatCurrrency(this.priceCents)}`
  }
...
export class Appliances extends Product {
  ...
  extraInfoHTML() {
    return `
    <a href= "${this.instructionsLink}" target = "_blank">Instructions for use</a>
    <a href= "${this.warrantyLink}" target = "_blank">Warrranty</a>
    `
  }
}
...
logThis()
logThis.call('hello, but in spanish')
